    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.subtitle}>"כשאת מרגישה שלמה עם המראה שלך - בין ביום חתונתך ובין בשגרת היומיום - זהו היופי האמיתי שלך"</div>
          ...
          <p className={styles.description}>
            היום, אני מתמקדת באיפור קבוע ובאיפור כלות, והכיף הכי גדול? לראות את החיוך של הלקוחות כשהן מסתכלות במראה! אני אוהבת ליצור מראה טבעי ומדויק שפשוט "עובד" - כזה שיגרום לך להרגיש נהדר בלי יותר מדי התעסקות. בין אם את רוצה גבות מושלמות שיחסכו לך זמן בבוקר או מראה חלומי ביום החתונה שלך, אני כאן כדי להפוך את החלום למציאות ולגרום לך להרגיש הכי טוב שאפשר!
          </p>
        </div>
      </div>
    <Recommendations/>
