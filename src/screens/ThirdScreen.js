    ...
    <div className={styles.container}>
      ...
      <div className={styles.faqList}>
        ...
        <FAQItem 
          ...
          answer="תיאום הציפיות איתי מאוד מדויק ומבוסס על ניסיון רב. לפני תחילת הטיפול אני מבצעת התאמת גוון קפדנית ומוודאת שהתוצאה תהיה טבעית ומדויקת בדיוק לפי מה שנכון לך." 
        />
        <FAQItem 
          question="אני מפחדת שהגבות יראו לא טבעיות או מוגזמות." 
          answer="הטכניקה שלי מתמקדת במראה טבעי שמשתלב בצורה מושלמת עם מבנה הפנים שלך. בנוסף, אנו עוברים יחד תהליך של סקיצה ואישור שלך לפני התחלת העבודה." 
        />
      </div>
